    ...
    return (
        <>
            ...
            <SwitchPrimitive.Control
                class={cn(
                    "inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent bg-shallow-background transition-[color,background-color,box-shadow] data-[disabled]:cursor-not-allowed data-[checked]:bg-foreground data-[disabled]:opacity-50",
                    local.class,
                )}
                {...others}
            >
